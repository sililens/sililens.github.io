...
var routes = [
    ...
    { path: 'page-upload', loadChildren: './page-upload/page-upload.module#PageUploadPageModule' },
    { path: 'modal-camera', loadChildren: './modal-camera/modal-camera.module#ModalCameraPageModule' },
    { path: 'modal-media', loadChildren: './modal-media/modal-media.module#ModalMediaPageModule' },
];
...
/***/ "./src/app/modal-camera/modal-camera.page.scss":
/*!*****************************************************!*\
  !*** ./src/app/modal-camera/modal-camera.page.scss ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = ":host ::ng-deep .inner-scroll {\n  margin-top: 16px !important;\n  width: 320px !important;\n  height: 230px !important; }\n\n:host-context(.inner-scroll) {\n  width: 320px !important;\n  height: 230px !important; }\n\n/deep/ .inner-scroll {\n  width: 320px !important;\n  height: 230px !important; }\n\n:host ::ng-deep .webcam-wrapper video {\n  width: 320px !important;\n  -o-object-fit: cover !important;\n     object-fit: cover !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/modal-camera/modal-camera.page.ts":
/*!***************************************************!*\
  !*** ./src/app/modal-camera/modal-camera.page.ts ***!
  \***************************************************/
/*! exports provided: ModalCameraPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ModalCameraPage", function() { return ModalCameraPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
...
var ModalCameraPage = /** @class */ (function () {
    function ModalCameraPage(navParams, modalCtrl, apiService) {
    ...
    ModalCameraPage.prototype.toggleWebcam = function () {
        this.showWebcam = !this.showWebcam;
    };
    ModalCameraPage.prototype.handleInitError = function (error) {
        this.errors.push(error);
    };
    ModalCameraPage.prototype.showNextWebcam = function (directionOrDeviceId) {
        // true => move forward through devices
        // false => move backwards through devices
        // string => move to device with given deviceId
        this.nextWebcam.next(directionOrDeviceId);
    };
    ModalCameraPage.prototype.handleImage = function (webcamImage) {
        console.info('received webcam image', webcamImage);
        this.webcamImage = webcamImage;
    };
    ModalCameraPage.prototype.cameraWasSwitched = function (deviceId) {
        console.log('active device: ' + deviceId);
        this.deviceId = deviceId;
    };
    Object.defineProperty(ModalCameraPage.prototype, "triggerObservable", {
        get: function () {
    ...
    Object.defineProperty(ModalCameraPage.prototype, "nextWebcamObservable", {
        get: function () {
    ...
    ModalCameraPage.prototype.closeModalCamera = function () {
    ...
    ModalCameraPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./modal-camera.page.html */ "./src/app/modal-camera/modal-camera.page.html"),
            styles: [__webpack_require__(/*! ./modal-camera.page.scss */ "./src/app/modal-camera/modal-camera.page.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _services_api_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"]])
    ], ModalCameraPage);
    return ModalCameraPage;
}());
...
/***/ "./src/app/modal-media/modal-media.page.scss":
/*!***************************************************!*\
  !*** ./src/app/modal-media/modal-media.page.scss ***!
  \***************************************************/
/*! no static exports found */
...
module.exports = ".upload-btn-wrapper {\n  position: relative;\n  overflow: hidden;\n  display: inline-block; }\n\n.btn {\n  border: 2px solid gray;\n  color: gray;\n  background-color: white;\n  padding: 8px 20px;\n  border-radius: 8px;\n  font-size: 20px;\n  font-weight: bold; }\n\n.upload-btn-wrapper input[type=file] {\n  font-size: 100px;\n  position: absolute;\n  left: 0;\n  top: 0;\n  opacity: 0; }\n\n.actionBtn {\n  width: 100%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/modal-media/modal-media.page.ts":
/*!*************************************************!*\
  !*** ./src/app/modal-media/modal-media.page.ts ***!
  \*************************************************/
/*! exports provided: ModalMediaPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ModalMediaPage", function() { return ModalMediaPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
...
var ModalMediaPage = /** @class */ (function () {
    function ModalMediaPage(modalCtrl, apiService) {
        this.modalCtrl = modalCtrl;
        this.apiService = apiService;
    ...
    ModalMediaPage.prototype.ngOnInit = function () {
        // console.log(this.photoType);
    };
    ModalMediaPage.prototype.fileChangeEvent = function (event) {
        this.imageChangedEvent = event;
    };
    ModalMediaPage.prototype.imageCropped = function (event) {
        this.croppedImage = event.base64;
    };
    ModalMediaPage.prototype.imageLoaded = function () {
        // show cropper
    };
    ModalMediaPage.prototype.loadImageFailed = function () {
        // show message
    };
    ModalMediaPage.prototype.submitCrop = function () {
        var _this = this;
        this.isSubmit = true;
        ...
        if (this.photoType == 'DriverLicence') {
            ...
            this.apiService.scanCar(cropImage).then(function (data) {
                // console.log(data);
                _this.modalCtrl.dismiss({
                    'photo': originPhoto,
                    'response': data
            ...
            this.apiService.scanRego(cropImage).then(function (data) {
                // console.log(data);
                _this.modalCtrl.dismiss({
                    'photo': originPhoto,
                    'response': data
            ...
            this.apiService.scanVin(cropImage).then(function (data) {
                // console.log(data);
                _this.modalCtrl.dismiss({
                    'photo': originPhoto,
                    'response': data
    ...
    ModalMediaPage.prototype.closeModalMedia = function () {
        this.modalCtrl.dismiss({
            'photo': null
        });
    };
    ModalMediaPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-modal-media',
            template: __webpack_require__(/*! ./modal-media.page.html */ "./src/app/modal-media/modal-media.page.html"),
            styles: [__webpack_require__(/*! ./modal-media.page.scss */ "./src/app/modal-media/modal-media.page.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _services_api_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]])
    ], ModalMediaPage);
    return ModalMediaPage;
}());
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.scanRego = function (photo) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
    ...
    ApiService.prototype.scanVin = function (photo) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
    ...
    ApiService.prototype.scanCar = function (photo) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
...
module.exports = __webpack_require__(/*! E:\siliconstack\lens\silicon_lens_ionic\src\main.ts */"./src/main.ts");
